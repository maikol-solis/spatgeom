...
#' @return A data frame with four variables. Variable \code{y = 0.6 * x1 + 0.3
#'   * x2 + 0.1 * x3} is the response, and \code{x1}, \code{x2} and \code{x3}
#'   are independent uniform random variables between \code{a} and \code{b}.
#' @examples
